...
('scroll of fireball', 'A magical scroll that can unleash a burst of flame upon use.', 'scroll', 150),
('rusty key', 'A small, rusty key. It might open something nearby.', 'quest item', 0),
('iron greatsword', 'A massive greatsword forged from iron. Heavy and powerful.', 'weapon', 300),
('welkynd stone', 'A glowing blue crystal, once used by the Ayleids to restore magicka.', 'consumable', 200),
('fine steel helmet', 'A well-crafted steel helmet, polished to a shine.', 'armor', 120),
('poison of weakness', 'A dark, viscous liquid that weakens an enemy upon contact when applied to a weapon.', 'consumable', 40),
('shiv', 'A crude, sharpened piece of metal. Barely a weapon, but effective in a pinch.', 'weapon', 5),
('imperial guard shield', 'A sturdy shield bearing the emblem of the Imperial Legion. Provides solid defense.', 'armor', 100),
('torch', 'A wooden stick with a burning rag, providing light in dark places.', 'tool', 3),
('journal entry', 'A torn page from a prisoner''s journal, detailing a secret passage.', 'quest item', 0),
('iron dagger', 'A basic, short blade, good for close quarters combat.', 'weapon', 20),
('leather boots', 'Simple leather boots, offering minimal protection but good for silent movement.', 'armor', 15),
('minor healing potion', 'A very small vial of red liquid. Restores a tiny bit of health.', 'consumable', 10),
('old map fragment', 'A piece of a torn map, showing a small section of the dungeon. Might lead to treasure.', 'quest item', 0),
('silver ring', 'A plain silver ring, possibly valuable or part of a set.', 'jewelry', 30),
('lockpicking guide', 'A small, worn book with diagrams on lockpicking. Reading it improves your skill.', 'book', 10),
('rusty shovel', 'A heavy, rusty shovel. Can be used to dig for treasure or as a blunt weapon.', 'tool', 8),
('bag of gold (small)', 'A small pouch containing a few gold coins.', 'currency', 10),
('scroll of ice storm', 'A magical scroll that conjures a freezing storm of ice shards.', 'scroll', 200),
('scroll of fire storm', 'A magical scroll that unleashes a devastating inferno, engulfing all nearby enemies.', 'scroll', 250),
('scroll of lightning bolt', 'A magical scroll that hurls a focused bolt of pure lightning at a single target.', 'scroll', 180),
('waterlogged book', 'A book ruined by water, its pages unreadable. Smells faintly of pond scum.', 'misc', 0),
('moldy bread', 'A hard, moldy piece of bread. Edible, but barely. Might give you character.', 'food', 1),
('empty wine bottle', 'A discarded glass bottle. Could be useful for holding liquids, or as a blunt projectile.', 'misc', 0),
('prisoner''s ragged trousers', 'Torn and stained trousers. Offer no protection, but surprisingly comfortable for escaping.', 'armor', 0),
('sweetroll', 'A delicious, sugary pastry. Restores a small amount of stamina.', 'food', 2),
('steel mace', 'A heavy, blunt weapon, effective against armored foes.', 'weapon', 80),
('studded leather armor', 'Leather armor reinforced with metal studs, offering better protection.', 'armor', 110),
('grand healing potion', 'A large vial of shimmering red liquid. Restores a significant amount of health.', 'consumable', 75),
('master lockpick', 'A finely crafted lockpick, making it easier to open difficult locks.', 'tool', 20),
('bag of gold (large)', 'A heavy sack filled with numerous gold coins.', 'currency', 100),
('scroll of healing hands', 'A magical scroll that emanates a soothing light, healing allies.', 'scroll', 100),
('enchanted amulet', 'A mysterious amulet that hums with a faint magical energy. Its purpose is unknown.', 'jewelry', 250),
('bear trap', 'A heavy iron trap designed to ensnare large creatures.', 'tool', 30),
('worn leather map', 'A tattered leather map, showing a larger, more detailed section of the region.', 'quest item', 0),
('glowing mushroom', 'A bioluminescent mushroom found in dark caves. Might have alchemical properties.', 'misc', 15),
('rusty sword', 'A heavily corroded sword, barely usable in combat.', 'weapon', 10),
('wooden shield', 'A simple, round wooden shield. Offers basic defense.', 'armor', 40),
('mana potion', 'A vial of shimmering blue liquid. Restores magicka.', 'consumable', 30),
('spyglass', 'A collapsible brass spyglass, useful for distant observation.', 'tool', 25),
('ancient coin', 'A very old, tarnished coin from a forgotten empire. Potentially valuable to collectors.', 'currency', 50),
('scroll of detect life', 'A magical scroll that reveals the presence of living creatures nearby.', 'scroll', 90),
('broken lantern', 'A rusted, broken lantern. Cannot provide light.', 'misc', 0),
('lucky rabbit''s foot', 'The dried foot of a rabbit. Said to bring good fortune, though its effectiveness is debatable.', 'misc', 5);
